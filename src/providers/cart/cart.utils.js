...
export const getCartTotalPrice = cartItems => cartItems.reduce((accumulatedQty, item) =>
    accumulatedQty + (item.quantity * item.price), 0);

export const getCartItemsCount = cartItems => cartItems.reduce((accumulatedQty, item) =>
